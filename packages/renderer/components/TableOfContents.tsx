...
export function TableOfContents({ items }: { items: TocItem[] }) {
  ...
  if (items.length === 0) return <div className="pv-no-print hidden xl:block xl:w-[var(--db-toc-w)] xl:shrink-0" />;
  return (
    ...
    <aside className="pv-no-print sticky top-28 hidden max-h-[calc(100vh-8rem)] self-start overflow-y-auto xl:block xl:w-[var(--db-toc-w)] xl:shrink-0">

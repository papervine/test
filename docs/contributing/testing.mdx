...
The `papervine dev` analogue used to validate against representative docs repos. It reports
rendered / degraded / 500 counts and exits non-zero on any 500 — run it for every renderer,
config, or nav change. Compatibility findings vs. representative docs repos are tracked in
`GAP-REPORT.md`.

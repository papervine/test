...
description: Every site publishes a machine-readable index of its docs at /llms.txt, the whole corpus at /llms-full.txt, and a clean-Markdown twin of every page at <path>.md.
public: true
---

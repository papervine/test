...
It renders with the same engine as the hosted site; save a file and refresh to see the
change. This is the fastest way to check an unfamiliar component or a tricky table before
pushing.

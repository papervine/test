...
**Settings → Danger zone** holds the irreversible deletes, following the familiar danger-zone
shape — a "delete my deployment" section and a "delete my organization" section, each with a
required reason and a red action.

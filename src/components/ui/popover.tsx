    ...
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          ...
          // `db-glass` is only 60% with a backdrop blur that didn't take effect here, leaving
          // the page legible straight through a list you're supposed to be reading. (Menus hit
          // the same problem and dropdown-menu.tsx now uses this token too.)
